...
const messages = {
  'zh-CN': {
    ...
    retry: '重试',
    records: '比较记录',
    recordsHint: '选择 2–10 条记录，并用箭头调整显示顺序。',
    selectedRecords: '已选记录',
    noRecordsSelected: '尚未选择记录。',
    selectAtLeastTwo: '请选择至少两条记录开始比较。',
  ...
  'en-US': {
    ...
    recordsHint: 'Select 2–10 records and use the arrows to set their order.',
    selectedRecords: 'Selected records',
    noRecordsSelected: 'No records selected yet.',
    selectAtLeastTwo: 'Select at least two records to start comparing.',
